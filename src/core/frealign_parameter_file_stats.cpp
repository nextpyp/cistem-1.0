...
/*FrealignParameterFileStats::FrealignParameterFileStats()
{
	parameter_file = NULL;
...
FrealignParameterFileStats::FrealignParameterFileStats(wxString wanted_filename, int wanted_access_type, int wanted_records_per_line)
{
...
void FrealignParameterFileStats::Open(wxString wanted_filename, int wanted_access_type, int wanted_records_per_line)
{
...
void FrealignParameterFileStats::Close()
{
...
void FrealignParameterFileStats::WriteCommentLine(wxString comment_string)
{
...
void FrealignParameterFileStats::WriteLine(float *parameters, bool comment)
{
...
int FrealignParameterFileStats::ReadFile(bool exclude_negative_film_numbers, int particles_in_stack)
{
	...
	wxPrintf("\n %i all data lines read\n", all_lines);
	wxPrintf("\n %i real data lines read\n", number_of_lines);
	current_line = 0;
...
void FrealignParameterFileStats::ReadLine(float *parameters)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
	MyDebugAssertTrue(current_line <= all_lines, "End of Frealign file reached");
...
float FrealignParameterFileStats::ReadParameter(int wanted_line_number, int wanted_index)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
...
void FrealignParameterFileStats::UpdateParameter(int wanted_line_number, int wanted_index, float wanted_value)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
...
void FrealignParameterFileStats::Rewind()
{
	current_line = 0;
}

float FrealignParameterFileStats::ReturnMin(int wanted_index, bool exclude_negative_film_numbers)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
...
float FrealignParameterFileStats::ReturnMax(int wanted_index, bool exclude_negative_film_numbers)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
	MyDebugAssertTrue(wanted_index >= 0 && wanted_index < records_per_line, "Index out of range");
...
double FrealignParameterFileStats::ReturnAverage(int wanted_index, bool exclude_negative_film_numbers)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
	MyDebugAssertTrue(wanted_index >= 0 && wanted_index < records_per_line, "Index out of range");
	...
	for (line = 0; line < all_lines; line++)
	{
		index = records_per_line * line;
		if (parameter_cache[7 + index] >= 0 || ! exclude_negative_film_numbers)
		{
...
void FrealignParameterFileStats::RemoveOutliers(int wanted_index, float wanted_standard_deviation, bool exclude_negative_film_numbers, bool reciprocal_square)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
	MyDebugAssertTrue(wanted_index >= 0 && wanted_index < records_per_line, "Index out of range");
...
float FrealignParameterFileStats::ReturnThreshold(float wanted_percentage, bool exclude_negative_film_numbers)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
...
void FrealignParameterFileStats::CalculateDefocusDependence(bool exclude_negative_film_numbers)
{
	int line;
	int index;
...
void FrealignParameterFileStats::AdjustScores(bool exclude_negative_film_numbers)
{
	int line;
	int index;
	float defocus;
...
float FrealignParameterFileStats::ReturnScoreAdjustment(float defocus)
{
...
void FrealignParameterFileStats::ReduceAngles()
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
...
float FrealignParameterFileStats::ReturnDistributionMax(int wanted_index, int selector, bool exclude_negative_film_numbers)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
	MyDebugAssertTrue(wanted_index >= 0 && wanted_index < records_per_line, "Index out of range");
...
float FrealignParameterFileStats::ReturnDistributionSigma(int wanted_index, float distribution_max, int selector, bool exclude_negative_film_numbers)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
	MyDebugAssertTrue(wanted_index >= 0 && wanted_index < records_per_line, "Index out of range");
...
void FrealignParameterFileStats::SetParameters(int wanted_index, float wanted_value, float wanted_sigma, int selector, bool exclude_negative_film_numbers)
{
	MyDebugAssertTrue(parameter_cache != NULL, "File has not been read into memory");
	MyDebugAssertTrue(wanted_index >= 0 && wanted_index < records_per_line, "Index out of range");
