/*  \brief  FrealignParameterFileStats class */

class FrealignParameterFileStats {
...
public:
	...
	FrealignParameterFileStats();
	~FrealignParameterFileStats();

	FrealignParameterFileStats(wxString wanted_filename, int wanted_access_type, int wanted_records_per_line = 17);
